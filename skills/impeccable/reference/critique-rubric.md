# Detailed Critique Rubric

Read for a comprehensive scored critique, audience walkthrough, or when one of
these lenses helps resolve a concrete design finding. These examples and score
bands are judgment aids, not measured user outcomes or release gates. Use the
actual audience and task; do not invent findings to fill categories or treat
example personas as research evidence.
...
- [ ] **Chunking**: Is information presented in digestible groups for the current task?
...
- [ ] **Minimal choices**: Are decisions simplified without hiding needed information?
...
#### Choice And Memory Burden

Judge the actual recognition, comparison, and recall burden of the task.
Grouping, visible context, and progressive disclosure can help; item counts
alone do not establish overload or predict abandonment. A familiar navigation
list can be easier than a short set of ambiguous choices.
