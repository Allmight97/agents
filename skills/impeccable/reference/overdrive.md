...
2. **Present these directions and get the user's pick before writing any code**, using the host's structured question tool when available. Explain trade-offs (browser support, performance cost, complexity). If the user already delegated the choice, name the strongest direction and proceed.
