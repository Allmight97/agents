...
If no design system exists, ask where it should live and how it should be structured before creating one, using the host's structured question tool when available.
